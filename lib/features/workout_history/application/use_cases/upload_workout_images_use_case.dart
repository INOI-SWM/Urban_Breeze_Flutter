...
class UploadWorkoutImagesUseCase {
  ...
  Future<AppResult<UploadResult>> execute({
    ...
    try {
      ...
      if (imageFiles.isEmpty) {
        return const AppFailure<UploadResult>(
          ValidationException(
      ...
      final UploadResult uploadResult = await repository.uploadWorkoutImages(
        activityId: activityId,
        imageFiles: imageFiles,
      );

      return AppSuccess<UploadResult>(uploadResult);
    } catch (e) {
      return AppFailure<UploadResult>(NetworkException(e.toString()));
    }
  }
}
