...
class RecommendedCourseRepositoryImpl implements RecommendedCourseRepository {
  ...
  @override
  Future<RecommendedCourseDetail> getCourseDetail(String routeId) async {
    final ApiResponseModel<RecommendedCourseDetailResponseModel> response =
        await _remoteDataSource.getCourseDetail(routeId);
